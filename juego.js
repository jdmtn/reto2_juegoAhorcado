...
function click_letras(event){
    ...
    const letra = button.innerHTML.toUpperCase( ); // poner letras en mayúsculas
    ...
    if( acerto == false ){
        ...
        //document.getElementById("letrasUsadas").innerHTML = html;
         //let html = document.getElementById("letrasUsadas").innerHTML;
    ...
    if( cant_errores == 7 ){
        id('resultado').innerHTML ="❌ Fin del juego, Perdiste!! la palabra era: " + palabrita;
        game_over( );
